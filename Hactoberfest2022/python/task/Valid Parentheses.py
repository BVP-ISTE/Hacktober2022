def checkparantheses(s):
    ...
    if circular!=0 or circular1!=0:
        if circular!=circular1:
            print("Round brackets are not balanced and hence are not valid.")
        else:
            print("Round brackets are balanced and hence valid.")
    if curly!=0 or curly1!=0:
        if curly!=curly1:
            print("Curly brackets are not balanced and hence are not valid.")
        else:
            print("Curly brackets are balanced and hence valid.")
    if square!=0 or square1!=0:
        if square!=square1:
            print("Square brackets are not balanced and hence are not valid.")
        else:
            print("Square brackets are balanced and hence valid.")
    if square==square1==curly==curly1==circular==circular1==0:
